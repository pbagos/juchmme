...
public class Encode {
    ...
    public Encode (int t, int encodeType){
        ...
        switch (encodeType){
            case 1: encodeGrouping="10001011011000000111";
                groupSymbols="10";
                break;
            case 2: encodeGrouping="24331212322444344211";
                groupSymbols="1234";
                break;
            case 3: encodeGrouping="12558187677424633788";
                groupSymbols="12345678";
                break;
            case 4: encodeGrouping="ACDEFGHIKLMNPQRSTVWY";
                groupSymbols="ACDEFGHIKLMNPQRSTVWY";
                break;
            default:encodeGrouping="10001011011000000111";
                groupSymbols="10";
                break;
        }
