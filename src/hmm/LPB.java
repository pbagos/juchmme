...
class LPB extends HMMAlgo {
    private String path;
    int i;
    private double best_sum;

    public LPB(HMM hmm, Seq x, final int nbh, boolean free, PosteriorProb postp2) {
        super(hmm, x);
